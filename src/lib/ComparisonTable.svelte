                ...
                >
                    <tbody class="w-full divide-y divide-gray-200">
                        ...
                        <tr class="flex flex-col w-full sm:table-row"
                            ><td class="px-2 py-2 sm:px-5 sm:py-3 whitespace-nowrap bg-gray-100"
                                >Website</td
                            >
                            {#each table.data as solution}
                        ...
                        {#each properties as prop}
                            <tr class="flex flex-col sm:table-row group">
                                <td
                                    class="px-2 py-2 sm:px-5 sm:py-3 whitespace-nowrap group-hover:bg-indigo-50 transition-colors bg-gray-100"
                                >
